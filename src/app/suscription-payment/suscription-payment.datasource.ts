...
export class SuscriptionPaymentDataSource implements DataSource<SuscriptionPayment> {
    ...
    loadSuscriptionPaymentByUserId(userId: number, pageNumber: number, pageSize: number) {
        this.loadingSubject.next(true);

        this.suscriptionPaymentService.getSuscriptionPaymentByUserId(userId, pageNumber, pageSize).pipe(
            catchError(error => {
